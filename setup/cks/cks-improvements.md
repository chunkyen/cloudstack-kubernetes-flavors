...
**Related to:**
- §25 (Node Pool Support) — force-remove would be essential for node pools where a single broken node shouldn't block pool management
...
## 24. Scale Control Plane Nodes (Add/Remove HA Control Plane Nodes)
...
- **§25 (Node pool support):** Node pools could extend to control plane pools with per-zone placement

---

## 25. Node Pool Support
...
| 22 | Make dashboard deployment optional during bootstrap | 🔴 |
| 23 | Force-remove failed/unreachable nodes | 🔴 |
| 24 | Scale control plane nodes (add/remove HA control plane) | 🔴 |
| 25 | Node pool support | 🔴 |
